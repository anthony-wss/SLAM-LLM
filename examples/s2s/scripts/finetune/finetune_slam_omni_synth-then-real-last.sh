...
# log settings
exp_name="s2s_train_v5-natdialog-synth-then-real-last-stage${stage}-${llm_name}-gpu${num_gpus}-btz${batch_size_training}-lr${lr}-nofp16-epochs${num_epochs}-whisper_${whisper_size}-latency${num_latency_tokens}-group${code_layer}"
...
ckpt_path=/work/u3937558/SLAM-LLM/exp/s2s_train_v5-natdialog-synth-then-real-stage2-Qwen2-0.5b-gpu4-btz8-lr1e-5-nofp16-epochs10-whisper_small-latency0-group3/s2s_epoch_4_step_416
