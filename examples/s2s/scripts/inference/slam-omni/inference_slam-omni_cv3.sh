...
speech_encoder_path="/work/u3937558/models/whisper/${whisper_size}.pt"   # replace this with your own whisper model path (different whisper size)
llm_path="Qwen/Qwen2-0.5B"
codec_decoder_path="/work/u3937558/speech_tokenizers/CosyVoice/pretrained_models/Fun-CosyVoice3-0.5B" # replace this with your own CosyVoice model path
...
codec_decoder_type=CosyVoice3
num_latency_tokens=0                # number of latency tokens (same as the number in training)
do_layershift=false                 # if false, tokens in each layers use the same codebook, otherwise, use different codebooks

ckpt_path=/work/u3937558/SLAM-LLM/exp/s2s_train_v5-Qwen2-0.5b-CosyVoice3-gpu8-btz8-lr2e-4-nofp16-epochs10-whisper_small-latency0-group3/s2s_epoch_2_step_5212
exp_name=eval_SLAM-Omni-CV3
# jsonl dataset
manifest_format=jsonl
val_data_path=/work/u3937558/StyleTalk/eval_dummy.jsonl
