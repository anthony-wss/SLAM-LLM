...
codec_decoder_path="/work/u3937558/models/CosyVoice-300M-SFT" # replace this with your own CosyVoice model path
...
ckpt_path=/work/u3937558/SLAM-LLM/exp/s2s_train_v5-natdialog-real-then-synth-last-stage2-Qwen2-0.5b-gpu4-btz8-lr1e-5-nofp16-epochs10-whisper_small-latency0-group3/s2s_epoch_3_step_944
exp_name=eval_NatDialog-Real-then-Synth
# jsonl dataset
